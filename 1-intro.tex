...
of Fourier transform over $G$ (where the base field is $\C$), and it
is worth mentioning that there is a vast literature on fast algorithms
for Fourier transforms. Relevant to our current context, we invite the
