...
the referee for pointing out that~\cite{BuClSh97} addresses lower and 
upper bounds for multiplying in associative algebras and there is a 
possibility for these results being applicable to our problem of 
testing invertibility in $\F[G]$. However, application of such bounds 
in our problem is not clear to us. 
