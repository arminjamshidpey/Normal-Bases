...
\rangle$, for various polynomials $P_i$.  \cite{Pol94}
...
\citeauthor{Pol94}'s \citeyearpar{Pol94} algorithm is only known to be
polynomial in $|G|$).
...
extended GCD algorithm~\citep[Chapter~11]{vzGathen13}, so our conclusion follows. 
...
the map is inspired by the one used in \citep[\S 47]{Curtis}.
