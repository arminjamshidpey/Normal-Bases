...
transforms over $G$, and it is worth mentioning that there is a vast
literature on fast algorithms for Fourier transforms (over the base field
$\C$). For recent progress in our context see
\cite{ClaMu04,MaRockWol18} and references therein, though it is
not clear how to apply these methods here.
...
Our algorithms make extensive of known algorithms for polynomial and matrix
...
best known value is $\omega \le 2.373$ by \citeN{LeGall14}. Over a field $\K$,
