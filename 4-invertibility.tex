...
Although the second algorithm above gives has a quadratic time, the first algorithm 
gives a better running time. More precisely, if $s \leq m$ then the first algorithm
